<template>
  <div class="allOrder materials">
    <PageTitle pageTitle="日原材料报表"></PageTitle>
    <div class="wrap">
...
export default {
  ...
  methods: {
    getTime() {
      this.leaveSel.time[0] = formatDate(new Date) + " 00:00:00"
      this.leaveSel.time[1] = formatDate(new Date) + " 23:59:59"
      this.enterSel.time[0] = formatDate(new Date) + " 00:00:00"
      this.enterSel.time[1] = formatDate(new Date) + " 23:59:59"
      console.log('日');
    },
    exportExcel,
    getStuffList,
