<template>
  <div class="allOrder materials">
    <PageTitle pageTitle="周原材料报表"></PageTitle>
    <div class="wrap">
...
<script>
import { ghGetWeekStartDate, ghGetWeekEndDate } from '@/Tools/time'
...
export default {
  ...
  methods: {
    getTime() {
      this.enterSel.time[0] = ghGetWeekStartDate() + " 00:00:00"
      this.enterSel.time[1] = ghGetWeekEndDate() + " 23:59:59"

      this.leaveSel.time[0] = ghGetWeekStartDate() + " 00:00:00"
      this.leaveSel.time[1] = ghGetWeekEndDate() + " 23:59:59"
      console.log('周');
    },
    getStuffList,
    getCharR,
