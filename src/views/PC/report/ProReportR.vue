<template>
  <div class="allOrder">
    ...
    <PageTitle pageTitle="日生产报表"></PageTitle>
    <div class="wrap">
...
import {  orderStateList, desPopOver, getCharR,
  getOrderList, orderDesFn, initChartLeft, initChartRight, exportExcel,
  postSelFn, closeSelForm, handleSizeChange, handleCurrentChange
