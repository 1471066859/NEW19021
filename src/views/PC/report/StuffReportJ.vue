<template>
  <div class="allOrder materials">
    <PageTitle pageTitle="季原材料报表"></PageTitle>
    <div class="wrap">
...
<script>
import { ghGetQuarterStartDate, ghGetQuarterEndDate } from '@/Tools/time'
...
export default {
  ...
  methods: {
    getTime() {
      ...
      this.leaveSel.time[0] = ghGetQuarterStartDate() + " 00:00:00";
      this.leaveSel.time[1] = ghGetQuarterEndDate() + " 23:59:59";

      this.enterSel.time[0] = ghGetQuarterStartDate() + " 00:00:00";
      this.enterSel.time[1] = ghGetQuarterEndDate() + " 23:59:59";
      console.log('季');
    },
    exportExcel,
    getStuffList,
