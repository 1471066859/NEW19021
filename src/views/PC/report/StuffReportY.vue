<template>
  <div class="allOrder materials">
    <PageTitle pageTitle="月原材料报表"></PageTitle>
    <div class="wrap">
...
<script>
import { ghGetMonthEndDate, ghGetMonthStartDate, } from '@/Tools/time'
...
export default {
  ...
  methods: {
    getTime() {
      this.leaveSel.time[0] = ghGetMonthStartDate() + " 00:00:00"
      this.leaveSel.time[1] = ghGetMonthEndDate() + " 23:59:59"
      this.enterSel.time[0] = ghGetMonthStartDate() + " 00:00:00"
      this.enterSel.time[1] = ghGetMonthEndDate() + " 23:59:59"
      console.log('月');
    },
    exportExcel,
    getStuffList,
