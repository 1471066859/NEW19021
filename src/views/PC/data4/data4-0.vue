<template>
  <div class="r-body">
    ...
    <div class="data_selects">
      <!-- 时间选择器 -->
      <sel-input-wrap sel_des="材,料,编,号" />
      <!-- 文本选择器 -->
      <sel-input-wrap sel_des="订,单,编,号" />
    ...
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="clId" label="材料编号" width="180"></el-table-column>
      <el-table-column prop="shopId" label="订单编号" width="180"></el-table-column>
      <el-table-column prop="time" label="时间" width="180"></el-table-column>
      <el-table-column prop="des" label="质量描述问题" width="180"></el-table-column>
      <el-table-column prop="name" label="操作人员" width="180"></el-table-column>
